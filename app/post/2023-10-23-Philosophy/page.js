...
async function Page() {
  return (
    <article>
      <h3>둥글지 않은 축구공</h3>
      <p>
        투자자들이 간과하는 투자하는데 있어서 가장 중요한 사실이 있다. 그건 바로 <strong>
        주식투자</strong>가 어렵다는 것이다. 인정하지 싫지만 주식투자는 정말 어렵다. 단,
      ...
      <p>
        문제는 이제부터다. 주식시장은 굳이 표현하자면, <strong>아마추어부터 최상위
        프로페셔널까지 모두가 하나의 리그에서 뛰고 있는 경기장이다.</strong> 메시와
      ...
      <p>
        ...
        나는 하루에 정말 많아야 2-3시간을 주식투자에 쓸 수가 있는데, <strong>바다건너
        월스트리트에서는 하루 12시간 씩 주 6-7일 노력하는 사람들이 있다.</strong>
      ...
      <p>
        ...
        자본주의 시스템의 꽃인 주식시장에 시간을 맡기면 되는 것이다. <strong>만약 훌륭한
        기업에 투자했다면, 투자자의 돈은 천천히, 그리고 꾸준히 증식하게 될
        것</strong>이다.
      </p>
      <p>
      ...
      <p>
        ...
        자식들에게 어떤 자식과 부모로 보여질 것인가. <strong>이제 자신의 선택에 따라
        달려있다.</strong>
      </p>
    </article>
  );
